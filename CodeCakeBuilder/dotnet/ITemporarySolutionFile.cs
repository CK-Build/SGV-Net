...
namespace CodeCake
{
    ...
    public interface ITemporarySolutionFile : IDisposable
    {
        ...
        /// </summary>
        NormalizedPath OriginalPath { get; }

        /// <summary>
        /// Excludes project from build by their names.
        /// This immediately updates the <see cref="Path"/> sln file.
        /// </summary>
        /// <param name="projectNames">Names of the projects to exclude from build.</param>
        Task ExcludeProjectsFromBuild( IActivityMonitor m, params string[] projectNames );

        /// <summary>
        /// Excludes project from build by their names. This updates the <see cref="Path"/> sln file.
        /// </summary>
        /// <param name="projectNames">Names of the projects to exclude from build.</param>
        Task ExcludeProjectsFromBuild( IActivityMonitor m, IEnumerable<string> projectNames );
    }
}
